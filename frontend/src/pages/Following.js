...
const Following = () => {
    ...
    // GET POSTS FROM DATABASE --> NEEDS LOGIC TO ONLY SHOW POSTS FROM WHO THE USER IS FOLLOWING
...
//       try {
//         const response = await fetch('/api/posts/following'); // Assuming '/following' route
//         const data = await response.json();
//         setPosts(data); // Set posts data including tags
//       } catch (error) {
...
const posts = [
    {
        ...
        price: 50,
        imageUrl: "./images/blank_image.webp", // Check this path
